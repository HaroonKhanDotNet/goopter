...
def set_up():
    ...
    driver.get(goopter_locators.goopter_url)
    sleep(2)
...
def log_in():
    driver.find_element(By.NAME, 'username').send_keys(goopter_locators.username)
    driver.find_element(By.NAME, 'password').send_keys(goopter_locators.password)
    sleep(5)
