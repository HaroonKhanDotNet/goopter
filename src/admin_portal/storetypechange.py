...
storetype = driver.find_element(By.XPATH, '/html/body/div[1]/div/section/section/main/div[2]/div/div[2]/div[1]/div[1]/div/div[2]/div')
storetype.click()

drop = driver.find_element(By.XPATH, '/html/body/div[1]/div/section/section/main/div[2]/div/div[2]/div[2]/div/div[2]/div/form/div[1]/div[2]/table/tbody/tr/td/span/div/div/div/div/div/div/div/div/div[3]/div/input')
drop.click()


dropselect = driver.find_element(By.XPATH, '/html/body/div[3]/div/div/div/div[2]/div[1]/div/div/div[6]/div')
dropselect.click()
