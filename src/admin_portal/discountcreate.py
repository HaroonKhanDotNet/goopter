...
creatediscount = driver.find_element(By.XPATH, '/html/body/div[1]/div/section/section/main/div[2]/div/div/div[2]/div/div[1]/div/div[1]/button')
...
datedrop = driver.find_element(By.XPATH, '/html/body/div[2]/div/div[2]/div/div[2]/div[2]/div/div[5]/div[2]/div/input')
datedrop.click()
