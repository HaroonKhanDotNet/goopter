...
def search_box(chromeBrowser):
    ...
    search_box_element = chromeBrowser.find_element(By. XPATH, "//span[@class='ant-input-affix-wrapper ant-input-affix-wrapper-focused']//input[@placeholder='Search by item']")
