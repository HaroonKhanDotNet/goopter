...
jpglogo = driver.find_element(By.XPATH,'/html/body/div[1]/div/section/section/main/div[2]/div/div[2]/div[2]/div/div[3]/div/form/div[1]/div[1]/div[2]/span/div/span/div/div/div/span/svg/path[1]')
jpglogo.click()
